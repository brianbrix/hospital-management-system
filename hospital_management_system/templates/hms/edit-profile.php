...
$sql=mysqli_query($con,"Update users set firstName='$fname',lastName='$lname',address='$address',city='$city',gender='$gender' where id='".$_SESSION['id']."'");
if($sql)
{
...
{
?>
<h4><?php echo htmlentities($data['firstName']." ".$data['lastName']);?>'s Profile</h4>
...
<div class="form-group">
	...
	<input type="text" name="fname" class="form-control" value="<?php echo htmlentities($data['firstName']);?>" >
														</div>
		<div class="form-group">
																	<label for="lname">
																		 User Name
																	</label>
			<input type="text" name="lname" class="form-control" value="<?php echo htmlentities($data['lastName']);?>" >
																</div>
